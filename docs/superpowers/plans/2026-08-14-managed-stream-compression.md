...
> required gate. The boxes below are ticked by outcome, checked against this
> repository on 2026-08-18, not as a record that each step ran as written. Do
> not re-run this plan. `ROADMAP.md`'s P3a section is the summary of what
> landed.
...
- [x] **Step 1: Write failing default and ceiling tests**
...
- [x] **Step 2: Write the cross-limit test**
...
- [x] **Step 2: Define the frame and transport contracts**
...
- [x] **Step 3: Define controls, transitions, and snapshots**
...
- [x] **Step 4: Define the session contract**
...
- [x] **Step 5: Define transition policy**
...
- [x] **Step 6: Remove `Codec` and update root tests**
...
- [x] **Step 1: Write failing framer ownership tests**
...
- [x] **Step 3: Implement the Java framer**
...
- [x] **Step 4: Keep raw packet helpers as low-level functions**
...
- [x] **Step 1: Write the policy and boundary tests**
...
- [x] **Step 2: Define compression controls**
...
- [x] **Step 3: Implement mandatory validation outside policies**
...
- [x] **Step 4: Implement outbound threshold behavior**
...
- [x] **Step 1: Replace descriptor tests**
...
- [x] **Step 4: Implement state and control validation**
...
- [x] **Step 1: Write transition table tests for both roles**
...
- [x] **Step 2: Write disconnect capability tests**
...
- [x] **Step 3: Implement generated transition matching**
...
- [x] **Step 4: Make transition application atomic**
...
- [x] **Step 5: Implement disconnect construction**
...
- [x] **Step 6: Regenerate and run focused checks**
...
- [x] **Step 1: Define the pre-frame interface**
...
- [x] **Step 2: Write claim and decline tests**
...
- [x] **Step 3: Implement the Java hook**
...
- [x] **Step 4: Test one-shot stream integration with a stub stream start**
...
- [x] **Step 1: Define stable stream errors**
...
- [x] **Step 3: Implement the shared budget**
...
- [x] **Step 4: Reserve processing memory before codec calls**
...
- [x] **Step 5: Implement lifecycle state and first-cause storage**
...
- [x] **Step 1: Build adversarial test transports**
...
- [x] **Step 2: Write failing read-pump tests**
...
- [x] **Step 3: Write failing write-pump tests**
...
- [x] **Step 5: Implement coordinator packet processing**
...
- [x] **Step 6: Run focused race checks**
...
- [x] **Step 1: Write inbound transition tests**
...
- [x] **Step 2: Write outbound transition tests**
...
- [x] **Step 3: Write runtime control tests**
...
- [x] **Step 4: Implement transition resolution**
...
- [x] **Step 6: Run protocol 47 transition tests**
...
- [x] **Step 1: Define immutable observations**
...
- [x] **Step 2: Write observation tests**
...
- [x] **Step 3: Implement a dedicated observation dispatcher**
...
- [x] **Step 4: Write graceful shutdown tests**
...
- [x] **Step 1: Add fuzz seeds from every malformed unit case**
...
- [x] **Step 2: Implement the status TCP scenario**
...
- [x] **Step 3: Implement the compressed login TCP scenario**
...
- [x] **Step 4: Add TCP fragmentation and shutdown variants**
...
- [x] **Step 5: Run focused and repeated checks**
...
- [x] **Step 1: Add pinned Node tooling**
...
- [x] **Step 2: Define the runner protocol**
...
- [x] **Step 3: Test Go client against Node server**
...
- [x] **Step 4: Test Node client against Go server**
...
- [x] **Step 5: Add the required Task target**
...
- [x] **Step 7: Run the interoperability gate**
...
- [x] **Step 1: Update the API example**
...
- [x] **Step 2: Update support boundaries**
...
- [x] **Step 3: Revise the roadmap order**
...
- [x] **Step 4: Record deferred conformance work**
...
- [x] **Step 6: Inspect generated and public API drift**
